...
export function BeamsBackground({
  ...
  const MINIMUM_BEAMS = 15;  // balanced: enough glow visible, not too heavy
  ...
  useEffect(() => {
    ...
    function animate() {
      ...
      // NOTE: No ctx.filter here — use CSS filter on canvas element instead (1x cost vs per-frame cost)
    ...
    // Pause when tab is hidden — stops GPU work when page is not visible
